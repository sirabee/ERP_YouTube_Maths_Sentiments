...
Uses identical parameters from the gradual approach methodology documented in
BERTopic_Methodology_Evolution_Summary.md for direct comparison.

Author: Graduate Student
Thesis: "Perceptions of Maths on YouTube: Analysis using BERT-based Topic Modelling and Sentiment Analysis"
Date: July 23, 2025
"""
